...
(function ($) {
    ...
    var options = {
         ...
         //   maxChar: 12,
            ...
            scores: [17, 26, 40, 50],
            security_text: "Security of this password is ",
            verdicts: ["Poor",  "Medium", "Strong"],
            showVerdicts: true,
            raisePower: 1.4,
        ...
        setProgressBar = function ($el, score) {
            ...
            if (options.showVerdicts) { //adds rating after putting a character
               if (options.viewports.verdict) {
                    $verdict = $(options.viewports.verdict).find(".password-verdict");
                } else {
                     $verdict = $el.siblings(".password-verdict");  //.find(".password-verdict");
                    if ($verdict.length === 0) {
                        $verdict = $('<p>') + options.security_text + $('<span class="password-verdict"></span></p>');
            ...
            if (score < options.scores[0]) {
                ...
                $verdict.text(options.security_text + options.verdicts[0]).css("color","#dd514c");
            ...
            //     if (options.showVerdicts) {
            //         $verdict.text(options.verdicts[1]).css("color","#dd514c");
            //     }
            // }
                ...
                if (options.showVerdicts) {
                    $verdict.text(options.security_text + options.verdicts[1]).css("color","#faa732");
                }
            }
            ...
            //     if (options.showVerdicts) {
            //         $verdict.text(options.verdicts[3]).css("color","#faa732");
            //     }
            // }
                ...
                if (options.showVerdicts) {
                    $verdict.text(options.security_text + options.verdicts[2]).css("color","#5eb95e");
                }
            }
        },
            ...
            init: function (settings) {
                ...
                return this.each(function (idx, el) {
                    ...
                    if (allOptions.showVerdicts) {
                        verdict = $('<span class="password-verdict">' + allOptions.security_text +  allOptions.verdicts[0] + '</span>');
                ...
                this.each(function (idx, el) {
                    ...
                    if (errors.length > 0) {
                        ...
                        if (viewports.errors) {
                            ...
                            output = $(output);
                            verdict = $el.siblings("span.password-verdict");
                            if (verdict.length > 0) {
                                el = verdict;
                            }
